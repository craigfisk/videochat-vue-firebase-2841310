<template>
  <div class="container-fluid mt-4">
    ...
    <div class="row" v-if="(user !== null && user.uid == hostID) || attendeeApproved"></div>
    <div v-else>
      <div class="col-md-8">
        <vue-webrtc
          ref="webrtc"
    ...
    <div>
      <p class="lead" v-if="user">
        Hi <strong class="text-primary font-weight-bold">{{ user.displayName }} </strong>, you're
        currently in the room waiting for the owner of the chat to add you to the meeting. Please
        wait.
      </p>
    </div>
  </div>
